  ...
  return (
    <footer className="border-t bg-white">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm text-gray-500">
              A research-driven proprietary trading firm. we apply quantitative
              methods and machine learning to trade systematically in global
              markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            <div aria-label="footer-services">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <LinkExternal
                  ...
                  disabled
                />
                <LinkExternal text="Research" url="https://chat.cerebase.com" />
                <LinkExternal
                  text="Infrastructure"
            ...
            <div aria-label="footer-legal">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <LinkInternal text="Disclosures" url="/terms-of-service" />
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="border-t">
        <div className="space-x-8 px-4 py-6 sm:px-6 lg:px-8 flex flex-row justify-between">
          <p className="text-xs text-gray-500">
            &copy; 2025 Cerebase A/S. All rights reserved.
          </p>

          <ul className="flex gap-3">
            <li>
              <a
                href="https://www.linkedin.com/company/cerebase"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <a
                href="https://github.com/cerebase"
                rel="noreferrer"
                target="_blank"
                className="text-gray-500 transition hover:opacity-75"
              >
...
const LinkExternal = ({ url, text, disabled }: LinkProps) => (
  <li>
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="text-gray-700 transition hover:underline hover:opacity-75 disabled:text-gray-300 underline-offset-4"
    >
      {text}
    </a>
  </li>
...
const LinkInternal = ({ url, text }: LinkProps) => (
  <li>
    <Link
      href={url}
      className="text-gray-700 transition hover:underline hover:opacity-75 underline-offset-4"
    >
      {text}
    </Link>
  </li>
