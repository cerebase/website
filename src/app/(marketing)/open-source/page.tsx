...
export default async function page() {
  ...
  const feature: Feature = {
    ...
    description:
      "Join us in our mission to develop open-source LLM applications that prioritize user-friendliness, accessibility, and inclusivity. Discover how we're fostering collaboration, innovation, and responsible technology development at cerebase on our Open Source page.",
  };
